...
function applyFrameworkSuggestions(result, options) {
...
function inferFramework(result, options) {
...
program.command("analyze").description("Analyze an error log file").argument("<path>", "Path to a log file").option("--lang <lang>", "Language: en|bn", "en").option("--mode <mode>", "Mode: beginner|pro", "beginner").option("--framework <framework>", "Framework: react|nextjs|express|node|unknown", "unknown").action((path, opts) => {
